    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            colors: [Color(0xFFC90606), Color(0xFF292828)],
                            stops: [0.0, 1.0],
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'uxo87fjc' /* Tipo de transferencia */,
                        ),
                        icon: Icon(
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'ok5xluvk' /* Seleccionar cuenta */,
                        ),
                        icon: Icon(
                          Icons.keyboard_arrow_down_rounded,
                          color: Color(0x00090303),
                          size: 15.0,
                        ),
                        fillColor:
                            FlutterFlowTheme.of(context).secondaryBackground,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'wngoi0v4' /* Tu estado actualizado es de: */,
                            ),
                            style:
                                FlutterFlowTheme.of(context).bodySmall.override(
                                      fontFamily: 'Inter',
          ...
          Text(
            FFLocalizations.of(context).getText(
              'xku4zxbe' /* Haz click para completar */,
            ),
